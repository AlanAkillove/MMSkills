...
INTENT_PATTERNS: List[Tuple[str, re.Pattern[str], str]] = [
    ...
    ("draft_full", re.compile(r"写整篇|整篇论文|正式写论文|把论文写出来|开始写论文|写一篇完整", re.I), "high"),
    ...
    ("figure", re.compile(r"画图|绘图|figure|plot|画出来|结果图", re.I), "medium"),
    ("figure_inspect", re.compile(r"检查图|修改图", re.I), "low"),
    ("experiment", re.compile(r"实验|跑代码|求解|python|matlab|敏感性", re.I), "medium"),
