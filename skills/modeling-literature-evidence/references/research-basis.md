...
本 skill 的来源证据设计与项目的规则 profile、主张—证据审计、术语审计和数据审计互相衔接；借鉴学术写作和开源审稿 skill 的“来源 manifest、原子主张、精确定位、冲突显式化”做法，但结合数模题意、模型、代码、数据和竞赛保密边界重新设计。
...
出版物的参考文献格式、期刊创新性标准和审稿流程不能直接套到数模竞赛；搜索/引用指标不能代替阅读；外部文献不能代替团队自身模型与实验。具体赛事规则仍由 `modeling-rules-profile` 单独核验。
