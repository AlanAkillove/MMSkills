...
4. 本项目的[模板化痕迹审查](../../modeling-ai-pattern-reviewer/SKILL.md)、[术语规范审查](../../modeling-terminology-auditor/SKILL.md)、[主张—证据审查](../../modeling-claim-evidence-audit/SKILL.md) 和[历史问题归纳](../../../docs/research/historical-project-findings.md) 规定了自然化前的上游锁定和回退边界。
