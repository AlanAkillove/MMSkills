...
2. 本项目[数据审计](../../modeling-data-audit/SKILL.md)、[模型架构](../../modeling-model-architect/SKILL.md)、[主张—证据审查](../../modeling-claim-evidence-audit/SKILL.md)和[历史问题归纳](../../../docs/research/historical-project-findings.md)共同指出泄漏、只报最优、缺基线、结果越界和代码—论文不一致是高频返工源。
