...
3. 本项目[实验验证](../../modeling-experiment-validator/SKILL.md)、[图表审计](../../modeling-figure-table-auditor/SKILL.md)、[数据审计](../../modeling-data-audit/SKILL.md)和[AI 披露设计](../../../docs/ai-disclosure-design.md)提供代码/数据/图表/论文的证据链接口；本 skill 只检查交付包和安全，不替代内部验证。
