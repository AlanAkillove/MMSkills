...
这里提供一个可编译的中性 TeX 骨架，提炼了数模论文常见的“摘要/summary—问题—假设—模型—验证—结论—参考文献—附录”组织方式，以及已有项目中比较实用的图表、公式、表格、代码和相对路径设置。
...
1. 复制整个 `templates/tex/` 目录到项目工作区，并把 `main.tex` 改成项目自己的编译入口；
