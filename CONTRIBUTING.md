...
涉及架构或规则边界的修改，请更新 `docs/architecture.md` 或对应 skill / 规则 profile，不要新增开发过程 ADR、研究计划或来源总账。临时计划放在已被忽略的 `.dev-notes/`。若实际复制第三方代码或文档，在对应文件头和 `THIRD_PARTY_NOTICES.md` 中保留许可证要求。
